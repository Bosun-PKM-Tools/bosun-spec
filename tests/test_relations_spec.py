...
_REQUIRED_METHODS = (
    ...
    "ropewalk.status",
    "gavel.record_minutes",
    "gavel.tally_motion",
    "lineage.query_ancestors",
    "lineage.add_individual",
    "legacy.verify_trust",
    "legacy.update_executor",
    "arbor.get_planting_schedule",
    "arbor.record_amendment",
    "the_glass.query_barometer",
    "the_glass.log_tide",
    "dispatch.log_outbound",
    "dispatch.trace_delivery",
    "registry.check_expiry",
    "registry.vault_document",
    "purser.list_subscriptions",
    "purser.calc_burn_rate",
    "cadence.log_habit_hit",
    "cadence.query_streaks",
    "reckoning.audit_bias",
    "reckoning.log_decision",
    "strongbox.audit_keys",
    "strongbox.derive_fingerprint",
    "trajectory.add_milestone",
    "trajectory.export_cv",
    "binnacle.search_axioms",
    "binnacle.annotate_scripture",
    "claim.record_prior_art",
    "claim.check_filing_status",
    "tribute.query_sizes",
    "tribute.log_gift",
    "weft.query_inventory",
    "weft.log_tailoring",
    "reverie.log_dream",
    "reverie.search_motifs",
    "provenance.verify_chain",
    "provenance.add_appraisal",
    "menagerie.log_vet_visit",
    "menagerie.list_vaccines_due",
    "muster.check_rations_expiry",
    "muster.audit_bugout_bag",
    "breadboard.query_pinout",
    "breadboard.link_schematic",
    "pavilion.generate_cue_sheet",
    "pavilion.tally_rsvps",
    "charthouse.query_timeline",
    "charthouse.get_lore_node",
    "commonwealth.log_hours",
...
_VALID_RPC_PARAMS = {
    ...
    "gavel.record_minutes": {"committee_slug": "steering-committee", "meeting_date": "2026-09-17", "notes": "Approved annual budget roadmap.", "attendees": ["Alice", "Bob"]},
    "gavel.tally_motion": {"committee_slug": "steering-committee", "motion_id": "motion-2026-09-01", "yeas": 12, "nays": 3, "abstentions": 1},
    "lineage.query_ancestors": {"individual_urn": "urn:lineage:individual:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "generations": 3},
    "lineage.add_individual": {"name": "Eleanor Vance", "pedigree_branch": "maternal", "gedcom_id": "I0042", "birth_date": "1920-04-12"},
    "legacy.verify_trust": {"trust_ref": "trust-revocable-2024", "durable_poa_hash": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"},
    "legacy.update_executor": {"trust_ref": "trust-revocable-2024", "executor_contact_urn": "urn:yeoman:contact:018f62f8-9a3b-7d23-bf72-5b9c03bfba43"},
    "arbor.get_planting_schedule": {"planting_zone": "8b", "taxonomic_species": "Solanum lycopersicum"},
    "arbor.record_amendment": {"plot_id": "bed-north-01", "soil_ph": 6.5, "amendment_type": "agricultural lime", "date": "2026-09-17"},
    "the_glass.query_barometer": {"station_id": "station-point-reyes", "hours": 24},
    "the_glass.log_tide": {"tide_gauge_urn": "urn:the-glass:station:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "height_meters": 1.85, "timestamp": "2026-09-17T12:00:00Z"},
    "dispatch.log_outbound": {"sender_urn": "urn:yeoman:contact:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "recipient_urn": "urn:yeoman:contact:018f62f8-9a3b-7d23-bf72-5b9c03bfba44", "courier_tracking": "1Z9999999999999999", "postmark_date": "2026-09-17"},
    "dispatch.trace_delivery": {"courier_tracking": "1Z9999999999999999"},
    "registry.check_expiry": {"document_type": "passport", "jurisdiction": "USA"},
    "registry.vault_document": {"document_type": "passport", "issuing_jurisdiction": "USA", "expiry_date": "2034-08-20", "encrypted_credential_cas": "urn:registry:cas:018f62f8-9a3b-7d23-bf72-5b9c03bfba43"},
    "purser.list_subscriptions": {"active_only": True, "billing_cadence": "monthly"},
    "purser.calc_burn_rate": {"timeframe_months": 12},
    "cadence.log_habit_hit": {"habit_id": "morning-meditation", "date": "2026-09-17", "notes": "20m zazen"},
    "cadence.query_streaks": {"min_streak": 7},
    "reckoning.audit_bias": {"decision_id": "dec-infra-migration-01", "framework": "cynefin"},
    "reckoning.log_decision": {"decision_title": "Adopt local-first SQLite architecture", "framework": "first-principles", "rationale": "Zero cloud vendor lock-in", "risk_tags": ["concurrency"]},
    "strongbox.audit_keys": {"hardware_token_serial": "YUBI-12345678"},
    "strongbox.derive_fingerprint": {"public_key": "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGabcdef user@box", "key_algorithm": "Ed25519"},
    "trajectory.add_milestone": {"role_title": "Principal Engineer", "organization_urn": "urn:trajectory:org:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "milestone_title": "Led distributed engine re-architecture", "date": "2026-09-17"},
    "trajectory.export_cv": {"format": "markdown", "include_private": False},
    "binnacle.search_axioms": {"query": "amor fati", "tradition": "Stoicism"},
    "binnacle.annotate_scripture": {"scripture_ref": "Meditations IV.3", "annotation": "Retreat into your own soul.", "credo_key": "inner_citadel"},
    "claim.record_prior_art": {"patent_number": "US11842099B2", "prior_art_urn": "urn:claim:patent:US10452390B1", "notes": "Antedates filing date"},
    "claim.check_filing_status": {"patent_number": "US11842099B2", "jurisdiction": "USPTO"},
    "tribute.query_sizes": {"recipient_contact_urn": "urn:yeoman:contact:018f62f8-9a3b-7d23-bf72-5b9c03bfba43"},
    "tribute.log_gift": {"recipient_contact_urn": "urn:yeoman:contact:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "gift_item": "Handmade linen notebook", "value_usd": 45.0, "date": "2026-09-17"},
    "weft.query_inventory": {"category": "outerwear", "material": "wool"},
    "weft.log_tailoring": {"garment_id": "garment-harris-tweed-01", "alteration_notes": "Shortened sleeves by 1.5cm", "measurements": {"sleeve_cm": 63.5}},
    "reverie.log_dream": {"description": "Navigating a subterranean labyrinth under open sea.", "lucidity_level": 4, "motif_tags": ["labyrinth", "ocean"], "date": "2026-09-17"},
    "reverie.search_motifs": {"motif": "labyrinth"},
    "provenance.verify_chain": {"item_urn": "urn:provenance:item:018f62f8-9a3b-7d23-bf72-5b9c03bfba43"},
    "provenance.add_appraisal": {"item_urn": "urn:provenance:item:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "appraisal_usd": 32000.0, "appraiser": "Sotheby's Maritime", "date": "2026-09-17"},
    "menagerie.log_vet_visit": {"pet_id": "pet-border-collie-01", "clinic_urn": "urn:menagerie:clinic:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "diagnosis": "Annual wellness check: excellent condition", "date": "2026-09-17"},
    "menagerie.list_vaccines_due": {"pet_id": "pet-border-collie-01", "as_of": "2026-09-17"},
    "muster.check_rations_expiry": {"as_of": "2026-09-17", "tier": "72h"},
    "muster.audit_bugout_bag": {"bag_id": "bag-primary-72h"},
    "breadboard.query_pinout": {"board_id": "board-esp32-s3-wroom", "pin_number": "GPIO21"},
    "breadboard.link_schematic": {"board_id": "board-esp32-s3-wroom", "schematic_cas": "urn:breadboard:cas:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "revision": "Rev C"},
    "pavilion.generate_cue_sheet": {"event_id": "event-gala-2026"},
    "pavilion.tally_rsvps": {"event_id": "event-gala-2026"},
    "charthouse.query_timeline": {"campaign_id": "campaign-second-age", "epoch": "Third Age"},
    "charthouse.get_lore_node": {"node_key": "lore.third_age.fall_of_gondolin"},
    "commonwealth.log_hours": {"initiative_name": "Community Food Pantry", "volunteer_urn": "urn:yeoman:contact:018f62f8-9a3b-7d23-bf72-5b9c03bfba43", "hours": 4.5, "date": "2026-09-17"},
